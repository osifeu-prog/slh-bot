...
ROLES = {
    "OWNER": ["*"],
    "PARTNER_READ_ONLY": [
        "public.view", "investor.view", "ai.investor", "market.view",
        "agents.view_approved", "alpha.distribute",
    ],
    "ADMIN": ["agents.view_all", "agents.manage", "exec.safe"],
    "USER": [
        "public.view", "agents.view_self", "economy.view_self",
        "economy.mutate_self", "agents.modify_self", "exec.safe",
    ],
    "UNKNOWN": ["public.view"],
}
