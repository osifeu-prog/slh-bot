def load_handlers(bot, context):
    ...
    def register_redirect(m):
        bot.reply_to(m, '׳ ֲג€˜ג€¹ ׳³ֲ ׳³ֲ ׳³ֲ׳³ג€׳³ֲ©׳³ֳ—׳³ֲ׳³ֲ© ׳³ג€˜׳²ֲ¾/join ׳³ֲ׳³ג€׳³ֲ¨׳³ֲ©׳³ֲ׳³ג€:')
    ...
    print("׳ ֲג€ג€ Loading modular handlers...")
    ...
    try:
        ...
        print("׳ ֲג€™ֲ¬ Chat registry handler loaded")
    except Exception as e:
    ...
    try:
        ...
        print("׳ ֲֲֲ SLH Gateway handler loaded")
    except Exception as e:
    ...
    try:
        ...
        def control_cmd(m):
            ...
            # commands loaded ׳’ג‚¬ג€ estimate from handler files
            import subprocess
            ...
            bot.reply_to(m,
                f"׳ ֲֲ§ֲ  SLH OS CONTROL TOWER\n\n"
                f"׳ ֲֲֲ¢ System: Online\n"
                f"׳ ֲג€ֲ¦ DB: state/db.json\n\n"
                f"׳ ֲג€˜ֲ¥ Users: {users}\n"
                f"׳ ֲג‚×ג€“ Agents: {len(agents_all)} (׳ ֲֲֲ¢{agents_active} ׳ ֲֲֲ¡{agents_idle} ׳ ֲג€ֲ´{agents_busy})\n"
                f"׳ ֲג€™ֲ° Token Supply: {token_supply}\n"
                f"׳ ֲג€”ֲ³ Votes: {votes}\n"
                f"׳ ֲג€ֲ¡ Commands loaded: ~{cmds}\n"
                f"׳ ֲג€ֲ§ Last Deploy: {commit}\n"
    ...
    try:
        ...
        def agent_onboard(m):
            ...
            # ׳³ג€˜׳³ג€׳³ג„¢׳³ֲ§׳³ֳ— ׳³ג€÷׳³ג‚×׳³ג„¢׳³ֲ׳³ג€¢׳³ֳ—
            if name in [a.get('name') for a in agents.values()]:
                bot.reply_to(m, f"׳’ֲֲ Agent '{name}' already exists")
                return
            
            # ׳³ג„¢׳³ֲ¦׳³ג„¢׳³ֲ¨׳³ֳ— ׳³ֲ¡׳³ג€¢׳³ג€÷׳³ֲ ׳³ג€”׳³ג€׳³ֲ© ׳³ֲ¢׳³ֲ schema ׳³ֲ׳³ג€”׳³ג„¢׳³ג€
            ...
            # ׳³ֲ©׳³ֲ׳³ג„¢׳³ג€”׳³ֳ— ׳³ג€׳³ג€¢׳³ג€׳³ֲ¢׳³ֳ— ׳³ג€˜׳³ֲ¨׳³ג€¢׳³ג€÷׳³ג„¢׳³ֲ ׳³ג€׳³ג€˜׳³ֲ׳³ג„¢׳³ֲ ׳³ֲ׳³ֲ¡׳³ג€¢׳³ג€÷׳³ֲ
            bot.reply_to(m, f"׳ ֲֲג€° Agent '{name}' onboarded successfully!\n"
                           f"׳ ֲג€ ג€ ID: {nid}\n"
                           f"׳ ֲג€ֲ {desc}\n\n"
                           f"Welcome to SLH OS! You can now:\n"
                           f"׳’ג‚¬ֲ¢ Read proposals\n"
                           f"׳’ג‚¬ֲ¢ Vote on decisions\n"
                           f"׳’ג‚¬ֲ¢ Propose new ideas\n"
                           f"׳’ג‚¬ֲ¢ Receive tasks via inbox\n\n"
                           f"Your AI assistant will help you get started.")
        print("׳’ֲג€¦ agent_onboard handler loaded")
    except Exception as e:
    ...
    try:
        ...
        def economy_cmd(m):
            ...
            bot.reply_to(m, f"׳ ֲג€™ֲ° Economy Dashboard\n׳ ֲג€ֲ¹ Credits: {credits}\n׳ ֲג€ֲ¹ Points: {points}\n׳ ֲג€ֲ¹ SLH: {token}")
    except Exception as e:
        print("economy_handler error:", e)
    print("׳ ֲֲ§ֲ© Modular + Legacy handlers loaded")
