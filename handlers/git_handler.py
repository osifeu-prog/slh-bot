...
WHITELIST_FILES = {'bot_gateway.py', 'doctor_handler.py', 'mini_app.html', 'dashboard.html', 'courses.json', 'railway.json', 'Procfile', 'requirements.txt', 'runtime.txt', '.railwayignore'}
...
def get_local_files():
    ...
    for root, dirs, files in os.walk(BASE_DIR):
        if root == BASE_DIR:
            dirs[:] = [d for d in dirs if d in WHITELIST_DIRS or d == 'state']
        else:
